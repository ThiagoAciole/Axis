...
from utils.utils import get_capa_path, get_rom_path
...
"""
            ...
            limpar_incompletos(base_nome)
            linha.after(0, lambda: (update_log(f"Erro: {e}"), botao.configure(state="normal")))
